...
public class WordCountNoMapRed {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 1) {
            System.out.println("Usage: java WordCountNoMapRed <input_file>");
            return;
        }
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                try {
                    ...
                    if (fullYear == 2019 && deathAvg > max2019) max2019 = deathAvg;
                    if (fullYear == 2020 && deathAvg > max2020) max2020 = deathAvg;
                    if (fullYear == 2021 && deathAvg > max2021) max2021 = deathAvg;
                    if (fullYear == 2022 && deathAvg > max2022) max2022 = deathAvg;
